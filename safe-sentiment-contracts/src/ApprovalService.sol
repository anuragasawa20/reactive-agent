...
import "@reactive/src/abstract-base/AbstractCallback.sol";
...
contract ApprovalService is AbstractCallback {
    ...
    address private constant CALLBACK_SENDER_ADDR =
        0x33Bbb7D0a2F1029550B0e91f653c4055DC9F4Dd8;
    ...
    constructor(
        ...
        uint256 extra_gas_
    ) payable AbstractCallback(CALLBACK_SENDER_ADDR) {
    ...
    function onApproval(
        ...
        uint256 adjusted_gas_price = tx.gasprice *
            gas_coefficient *
            (extra_gas + gas_init - gasleft());
        // TODO: This is just to keep the testing/debugging costs down.
        adjusted_gas_price = adjusted_gas_price > 100
            ? 100
            : adjusted_gas_price;
